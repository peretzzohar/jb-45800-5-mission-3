...
const log_error_1 = __importDefault(require("./middlewares/error/log-error"));
...
(async () => {
    ...
    // error middlewares
    app.use('/', log_error_1.default);
    app.use('/', error_responder_1.default);
    await sequelize_1.default.sync({ force: !!config_1.default.get('app.sync.force') });
    // starting the server
